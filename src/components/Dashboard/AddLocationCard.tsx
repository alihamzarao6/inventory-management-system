...
export const AddLocationCard: React.FC<AddLocationCardProps> = ({
  type,
  onClick,
}) => (
  <div
    onClick={onClick}
    className="bg-white/50 backdrop-blur-sm rounded-2xl border-2 border-dashed border-gray-200 hover:border-blue-500 transition-colors duration-300 cursor-pointer group h-full flex flex-col justify-center"
  >
