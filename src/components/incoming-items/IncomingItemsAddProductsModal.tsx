...
const IncomingItemsAddProductsModal: React.FC<AddProductsModalProps> = ({
  open,
  onOpenChange,
  locationId,
  checkedItemIds,
  ...
  return (
    <Dialog open={open} onOpenChange={onOpenChange}>
      <DialogContent className="sm:max-w-[800px] p-0 gap-0 bg-gray-100">
        <DialogHeader className="p-6 bg-white flex flex-row justify-between items-center">
...
export default IncomingItemsAddProductsModal;
