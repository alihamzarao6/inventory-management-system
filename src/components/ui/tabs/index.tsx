...
>(({ className, ...props }, ref) => (
  <TabsPrimitive.Trigger
    ...
    className={cn(
      ...
      'hover:bg-gradient-to-t hover:from-gray-100 hover:to-white dark:hover:from-gray-700 dark:hover:to-gray-600',
...
>(({ className, ...props }, ref) => (
  <TabsPrimitive.Content
    ref={ref}
    className={cn(
      'mt-4 rounded-xl bg-white p-6 shadow-lg transition-all dark:bg-gray-800',
      'focus-visible:ring-2 focus-visible:ring-blue-400 focus-visible:ring-offset-2',
      className
    )}
    {...props}
